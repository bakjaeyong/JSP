	  ...
	  <tr>
	   ...
	   <table>
	     <tr>
	      ...
	      <td><input name="title" size="50" maxlength="100" name="title" value=<%=title %>></td>
	      <td>
		</td>
	     </tr>
	    ...
	    <tr>
	      ...
	      <td><input name="name" size="50" maxlength="50" name="name" value=<%=name %>></td>
	      <td> </td>
	     </tr>
	      <tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
	    <tr>
	     ...
	     <tr align="center">
          ...
          <button type="button" onclick="location.href='BoardDeletePro.jsp?title=<%=title %>'">삭제</button>
